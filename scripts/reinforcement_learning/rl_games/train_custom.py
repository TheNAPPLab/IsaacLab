...
parser.add_argument("--wandb-project-name", type=str, default="IsaacLab-scripts_reinforcement_learning_skrl", help="the wandb's project name")
parser.add_argument("--wandb-entity", type=str, default="oluwatosin_oseni-colorado-school-of-mines", help="the entity (team) of wandb's project")
